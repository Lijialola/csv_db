...
from csv_db import PACKAGE_NAME, __email__, __author__
...
setup(
    ...
    name=PACKAGE_NAME,
    version=version,
    description='Modulo para la creación de bases de datos en memoria con persistencia en documentos csv',
